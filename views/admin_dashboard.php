...
const customerMonths = <?php echo json_encode($customerMonths); ?>;
...
new Chart(document.getElementById('salesChart'), {
  ...
  data: {
    labels: months,
    datasets: [{ label: 'Revenue', data: revenues, borderColor: 'rgba(75, 192, 192, 1)', fill: false }]
  }
});
...
new Chart(document.getElementById('ordersChart'), {
  ...
  data: {
    labels: months,
    datasets: [{ label: 'Orders', data: orderCounts, backgroundColor: 'rgba(153, 102, 255, 0.2)', borderColor: 'rgba(153, 102, 255, 1)', borderWidth: 1 }]
  }
});
...
new Chart(document.getElementById('productsChart'), {
  ...
  data: {
    labels: productNames,
    datasets: [{ data: productSales, backgroundColor: ['red', 'blue', 'green', 'orange', 'purple'] }]
  }
});
...
new Chart(document.getElementById('customersChart'), {
  ...
  data: {
    ...
    datasets: [{ label: 'New Customers', data: newCustomers, backgroundColor: 'rgba(255, 159, 64, 0.2)', borderColor: 'rgba(255, 159, 64, 1)', borderWidth: 1 }]
  }
});
</script>
</body>
